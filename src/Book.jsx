...
export default function Book({ book, toggleBook, removeBook, selectTag }) {
    ...
    <tr style={{ display: book.hide ? "none" : "" }}>
      <td
        style={{
          ...
          backgroundColor: book.read ? "lightgreen" : "white",
        }}
      >
      ...
      <td>
        <button
          style={{ display: "inline-block", backgroundColor: "tomato" }}
